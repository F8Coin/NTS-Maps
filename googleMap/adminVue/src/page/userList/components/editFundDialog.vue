        ...
        <div class="form">
            <el-form 
                ...
                <el-form-item prop='mainAccount' label="企业主账号:">
                    <el-input type="text" disabled="disabled" v-model.number="form.mainAccount" placeholder="请输入创建者企业主账号"></el-input>
                </el-form-item>

                <el-form-item prop='accountName' label="账户名称:">
                    <el-input type="text" disabled="disabled" v-model.number="form.accountName" placeholder="请设置新建账户的名称"></el-input>
                </el-form-item>

                <el-form-item prop='accountPassword' label="账户密码:">
                    <el-input type="text" v-model.number="form.accountPassword" placeholder="请输入需要修改的账户的密码"></el-input>
                </el-form-item>
...
<script>
  ...
  export default {
      ...
      methods:{
            ...
            // 企业管理- 修改企业用户
            async editCompanyAccount(params) {
                let res= await api.editAccount(params)
                if(res.data.code == 0) {
                ...
                this.$refs[form].validate((valid) => {
                    if (valid) {
                        this.editCompanyAccount({
                            ...
                            accountTypeId: '1',
                            nickname: 'NTS',
                            companyId: this.dialogRow.companyId
                        });
                    }else {
